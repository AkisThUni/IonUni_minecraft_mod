...
public class ModArmorItem extends ArmorItem {
    ...
    // Besically This gives the attribute (effect) on the Armor Material. This is where we put the custom effect.
    ...
    // This checks constantly every couple ticks if the armour is worn.
    @Override
    ...
    // This "maps" an effect to each armour material.
    ...
    // This applies the effect to player
    ...
    // This checks if the player has the correct thing on
    ...
    // This checks if player has full armor.
